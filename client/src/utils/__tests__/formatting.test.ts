...
describe('Formatting Utils', () => {
  describe('formatPrice', () => {
    it('should format price in millions correctly', () => {
      expect(formatPrice(500000000)).toBe('Rp 500 Jt');
    ...
    it('should format price in thousands correctly', () => {
      expect(formatPrice(5000000)).toBe('Rp 5 Jt');
      expect(formatPrice(15000000)).toBe('Rp 15 Jt');
    });
    ...
    it('should handle per meter pricing', () => {
      expect(formatPrice(8000000, { isPerMeter: true })).toBe('Rp 8 Jt/m²');
      expect(formatPrice(15000000, { isPerMeter: true })).toBe('Rp 15 Jt/m²');
    });
