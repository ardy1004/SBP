          ...
          <div className="relative w-full md:w-3/4 lg:w-1/2 bg-white rounded-t-lg md:rounded-lg shadow-lg p-6 z-60">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input value={ltMin} onChange={(e) => setLtMin(e.target.value === "" ? "" : Number(e.target.value))} placeholder="Min LT" />
              </div>
              <div>
                <label className="block text-sm mb-1">Luas Tanah Max (m²)</label>
                <Input value={ltMax} onChange={(e) => setLtMax(e.target.value === "" ? "" : Number(e.target.value))} placeholder="Max LT" />
              </div>

              <div>
                <label className="block text-sm mb-1">Luas Bangunan Min (m²)</label>
                <Input value={lbMin} onChange={(e) => setLbMin(e.target.value === "" ? "" : Number(e.target.value))} placeholder="Min LB" />
              </div>
              <div>
                <label className="block text-sm mb-1">Luas Bangunan Max (m²)</label>
                <Input value={lbMax} onChange={(e) => setLbMax(e.target.value === "" ? "" : Number(e.target.value))} placeholder="Max LB" />
              </div>
