  ...
  try {
    ...
    if (properties.length === 0) {
      ...
      const sampleProperties = [
        ...
        {
          kodeListing: "TEST001",
          judulProperti: "Kost Exclusive Dekat UGM Yogyakarta",
          deskripsi: "Kost eksklusif dengan lokasi strategis dekat Universitas Gadjah Mada (UGM). Cocok untuk mahasiswa dengan fasilitas lengkap dan harga terjangkau.",
          jenisProperti: "kost",
          luasTanah: "200",
          luasBangunan: "150",
          kamarTidur: 8,
          kamarMandi: 8,
          legalitas: "SHM",
          hargaProperti: "150000000",
          provinsi: "DI.Yogyakarta",
          kabupaten: "Sleman",
          alamatLengkap: "Jl. Kaliurang KM 5, Dekat UGM",
          imageUrl: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop",
          imageUrl1: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=800&h=600&fit=crop",
          status: "dijual",
          ownerContact: "+62 812 3456 7890",
          isPremium: false,
          isFeatured: false,
        ...
        {
          kodeListing: "TEST002",
          judulProperti: "Rumah Mewah Dekat UGM dan RS Sardjito",
          deskripsi: "Rumah mewah dengan lokasi premium dekat UGM dan RS Sardjito. Area strategis dengan akses mudah ke berbagai fasilitas pendidikan dan kesehatan.",
          jenisProperti: "rumah",
          luasTanah: "300",
          luasBangunan: "250",
          kamarTidur: 4,
          ...
          provinsi: "DI.Yogyakarta",
          kabupaten: "Sleman",
          alamatLengkap: "Jl. Farmako, Sekip, Yogyakarta - Dekat UGM",
